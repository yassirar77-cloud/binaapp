...
export function Modal({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'relative w-full bg-ink-800 border border-ink-700 rounded-2xl shadow-lift',
          'animate-scale-in',
          sizes[size],
        )}
      >
        {(title || description) && (
          <div className="px-6 pt-6 pb-4 border-b border-ink-700/70">
            {title && (
        ...
        {footer && (
          <div className="px-6 py-4 border-t border-ink-700/70 flex items-center justify-end gap-2">
            {footer}
          </div>
        )}
      </div>
