            ...
            for order in (preparing_result.data or []):
                ...
                if user_id:
                    await self._create_event(
                        ...
                        description="Pesanan masih dalam status 'preparing' lebih 45 minit",
                        severity="warning",
            ...
            for order in (ready_result.data or []):
                ...
                if user_id:
                    await self._create_event(
                        ...
                        description="Pesanan siap tetapi tiada rider ditugaskan lebih 15 minit",
                        severity="warning",
            ...
            for order in (pending_result.data or []):
                ...
                if user_id:
                    await self._create_event(
                        ...
                        description="Pesanan menunggu pembayaran lebih 30 minit - mungkin webhook gagal",
                        severity="warning",
                        details={
                            "order_id": order["id"],
