/**
 * BinaApp Terms of Service v3.1 — English (translation for convenience only)
 *
 ...
 *
 * Word count: ~11200 EN words. Estimated reading time: 49 minutes at
...
- **AI-generated video and images:** Hero video clips are **synthetic footage produced by AI** — not real footage of your shop, your staff, or your food. You must review every clip and must **not present it to customers as real footage of your business**. Doing so may breach the Trade Descriptions Act 2011 and the Consumer Protection Act 1999, and that liability is yours, not ours (section 11).
- **Automated content controls:** The platform may automatically remove, rewrite or block content on your generated website — unsupported claims, facts you never supplied, unverifiable links, failing images — and may refuse to publish a page. This is a safety net, **not a guarantee that your page is accurate** (section 13A).
- **Showcase:** We may feature your published website, your business name and your hero clip on binaapp.my and in our marketing, under a licence you can withdraw at any time by emailing admin@binaapp.my (section 14A).
- **What BinaApp is NOT responsible for:** Food quality, delivery times, customer-merchant disputes, unreviewed AI hallucinations and unreviewed AI video, customer payments that fail to arrive via static QR, and rider actions during delivery.
...
- HTML website generation (a structured design plan, then the page built against it);
- Menu and hero image generation;
- **Hero video generation** — short synthetic video clips for the top of your website;
- Automated visual review of the generated page (a vision model scores screenshots of your page);
...
- **Misleading synthetic video** — see the dedicated clause below.

**11A. AI-generated video — specific disclaimer and merchant obligation:**

A hero video clip produced by BinaApp is **synthetic footage generated by an AI model**, either from a text prompt alone or by animating a single photograph you supplied.

**Understand what the clip is and is not:**

- It is **not a recording of your premises, your kitchen, your staff, or your actual food**, even where it looks like one;
- The food shown is **not your food**. The interior shown is **not your interior**. The people shown, if any, **do not exist and are not your staff or customers**;
- AI video commonly contains physical impossibilities, malformed hands, unreadable signage and incorrect equipment.

**Your obligations before publishing a clip:**

- **Review every clip in full before it goes on your live site.** A clip is never published automatically without your action;
- **Do not present a generated clip as genuine footage of your business.** Do not caption it, describe it or answer customer questions in a way that states or implies it shows your real premises, your real staff or the actual dish a customer will receive;
- **Do not use a generated clip to depict a dish, portion size, ingredient or facility you do not actually offer.** Where the clip is decorative, keep your real menu photographs and descriptions as the accurate record of what you sell;
- **Do not generate a clip from a photograph you do not have the right to use.** Where the photograph shows staff, customers or other identifiable individuals, obtain their consent before animating it — that photograph is transferred to an AI provider in the People's Republic of China (Privacy Policy section 16).

**Legal exposure is yours:**

Publishing synthetic footage in a way that misleads a consumer about the goods or services you supply may constitute a **false trade description under the Trade Descriptions Act 2011**, a **misleading representation under the Consumer Protection Act 1999**, or a breach of the Malaysian Code of Advertising Practice. It may also breach the platform policies of any social network you repost the clip to.

**You are solely responsible for how you present and caption a generated clip.** BinaApp gives you a generation tool, does not decide how you describe your business to your customers, and **accepts no liability** for any regulatory action, enforcement, penalty or consumer claim arising from your use or captioning of a generated clip. Your indemnity under section 19 extends to such claims.

**Credits and failures:** hero video generation consumes a credit or addon unit. Where a clip fails to render through a provider or platform fault, the credit is returned automatically. Dissatisfaction with the creative result of a successfully rendered clip is **not** a fault and does not attract a refund — AI output is inherently variable, and you should preview before generating at volume.
...
Use of AI features involves data transfer to third-party AI providers (Stability AI, DeepSeek, **Z.ai / Zhipu AI**, Qwen, Anthropic). See **Privacy Policy sections 6, 6A and 16** for details of providers, processing regions, and PII risks.

Note in particular that the **automated visual review sends screenshots of your generated page** — including your business name, address and phone number as rendered on it — to a vision model, and that the **photo-to-video path sends a photograph you selected** to a provider in the People's Republic of China.
...
- Disclosure of data to third-party AI providers (Stability AI, DeepSeek, Z.ai / Zhipu AI, Qwen, Anthropic);
- Disclosure to media and infrastructure providers (Cloudinary, Supabase, Render, Vercel) and to the third parties whose files your generated website loads into a visitor's browser (Cloudinary, Google Fonts, the Google Maps embed, Unsplash, public code CDNs — Privacy Policy section 13A);
- One-time geocoding of your business address via OpenStreetMap Nominatim at publish time;
- Cross-border data transfers to Singapore, the United States, and the People's Republic of China;
- Collection of **cookieless** first-party analytics data on generated websites, honouring Do-Not-Track and Global Privacy Control;
- Retention of generation quality records (Privacy Policy section 6B);
...
**Status of previous privacy commitments:**

Do-Not-Track support was delivered, and analytics were additionally re-engineered to be cookieless with Global Privacy Control honoured. The explicit consent UI for AI features handling PII and the visitor notice banner were **not** delivered by their 20 July 2026 deadline and are recommitted to **31 January 2027**. See **Privacy Policy section 20** for the full status report.`,
    },
...
Automatic generation of websites, images, video and text using multiple AI providers. Generation runs in two passes — a structured design plan, then the page built against it — followed by automated review. See **Privacy Policy sections 6 and 6A** for details of each provider.
...
**(l) Hero video studio:**
Generation, preview, library, application and removal of short AI-generated video clips for the top of your website. Clips are generated from a prompt, or by animating one photograph you supply. Subject to section 11A and to credit or addon consumption.

**(m) Design Studio:**
Post-generation editing of your published page — sections, imagery, palette, copy and layout — including removal of sections such as the map embed.

**(n) Website rebuild and style variations:**
Regeneration of an existing website, and generation of alternative style treatments for comparison before publishing.

**(o) Template gallery:**
A library of design directions and starting points for generation.

**(p) QR toolkit, promo kit, counter kit and business kit:**
Generation of printable and shareable business collateral — site QR codes, promotional graphics, counter-top materials and business assets — derived from your published website.

**(q) Google Maps embed and address geocoding:**
A map frame on your contact section, pointed at coordinates derived from the business address you entered. The frame is served to your visitors by Google under Google's own privacy policy (**Privacy Policy section 13A**). You may remove the map in the Design Studio.

**(r) Booking / reservation form section:**
An optional table booking form on your generated website. **The form does not submit to BinaApp.** Submissions are assembled in the visitor's browser and handed to WhatsApp as a pre-filled message. BinaApp does not receive, store, back up or export bookings — they exist only in your WhatsApp account, and you are their sole controller. See **Privacy Policy section 11A**.

**(s) Issue reporting and free regeneration:**
A route to report a defect in a generated website, which may qualify for a capped number of free regenerations.

**(t) Referrals, trust score and merchant penalties:**
Referral tracking, a merchant trust indicator, and the penalty mechanisms described elsewhere in these Terms.

**(u) SLA monitoring and website health checks:**
Automated monitoring of generated websites and delivery service levels.
...
BinaApp may add, modify, or remove features from time to time. Material new features or removals will be notified to you in accordance with section 22 (Amendments to Terms).`,
...

    {
      ...
      title: '13A. Automated Content Controls',
      content: `The generation pipeline applies automated checks that can **alter, remove or block content on your own website, and can refuse to publish it**, without a person reviewing the decision. By using the Services you accept that these controls operate on your content.

**(a) What the controls do**

- **Unsupported claim control** — promotional claims that the generated page cannot support from what you actually supplied (for example superlatives, health claims, or awards you never entered) may be rewritten or removed;
- **Fact control** — a section that states a fact about your business that you never supplied may be removed rather than published;
- **Location consistency block** — where the address you entered names a different town than your business description, generation is blocked until you resolve the conflict;
- **Image controls** — every AI-generated image is checked by a vision model for rendered text, human faces and category match. A failing image is regenerated once and then dropped, and the section renders a text tile instead;
- **Design critique gate and quality floor** — the rendered page is scored by a vision model and against deterministic layout rules. A page below the threshold is regenerated rather than served, and a page that fails the quality floor is not published;
- **Publish guard** — a publish that would overwrite a live site is refused until you confirm it;
- **Link guard** — links that cannot be verified are removed or neutralised rather than published broken;
- **Image moderation** — uploaded imagery may be screened, and content violating section 6 may be rejected.

**(b) Why they exist**

These controls exist to reduce the risk that an AI pipeline publishes something untrue about your business — which would be your legal exposure, not ours. They are a safety net, applied on a best-effort basis.

**(c) What they are NOT**

**These controls are not a warranty.** BinaApp does **not** warrant that:

- Every inaccurate statement on your page will be caught;
- Every claim left standing is substantiated, lawful, or compliant with the Trade Descriptions Act 2011, the Consumer Protection Act 1999, halal certification requirements, or any advertising code;
- Every image or clip on your page is suitable, accurate, or free of third-party rights.

**You remain fully responsible for reviewing your published website** (sections 7, 8 and 11). A page that passed every automated control is still your page, published by you, and its accuracy is your obligation.

**(d) They can be wrong in the other direction too**

A control may remove something that was in fact correct, or block a generation it should not have. Where that happens:

- You may re-enter the information through the structured fields, which are treated as authoritative;
- You may edit the published page directly in the Design Studio;
- You may request a manual review at **admin@binaapp.my** (**Privacy Policy section 19**).

BinaApp is **not liable** for lost time, lost generations, lost credits or lost business arising from an automated control acting correctly or incorrectly, save to the extent of section 18.

**(e) Right to change the controls**

BinaApp may add, tune, or remove these controls at any time as generation quality work continues. Changes to the controls are operational and are **not** treated as material amendments under section 22.`,
    },
...
For content generated through the BinaApp AI pipeline (HTML websites, menu images, hero images, **hero video clips**, reply texts):
...
- **BinaApp does not warrant** that AI-generated content is **free from third-party copyright infringement**. AI-generated images and video may resemble existing copyrighted works (see section 11);
- **You are responsible** for copyright infringements arising from the use of AI-generated content;
- **AI provider terms pass through to you.** Ownership of AI output is subject to the terms of the provider that generated it (Stability AI, Z.ai / Zhipu AI, DeepSeek, Qwen). Those terms may restrict certain uses, and may change. BinaApp passes on only the rights it holds and can transfer no more than that;
- **Legal certainty over AI output is unsettled.** In several jurisdictions, purely machine-generated output may not attract copyright protection at all, which may limit your ability to stop a third party copying it. BinaApp makes no representation on this point.

**14.5 Stock Photography and Third-Party Assets**

Where a generated page uses **stock photography** (served from Unsplash) or third-party icon sets, fonts or code libraries:

- **You do not own them.** They are used under the licence the provider grants, and that licence — not these Terms — governs what you may do with them;
- **The Unsplash Licence permits commercial use but does not permit** reselling the photograph as-is, compiling the photographs into a competing service, or using them in a way that implies endorsement by the photographer or by the people shown;
- **A stock photograph is not a photograph of your business.** The same restrictions in section 11A about not presenting synthetic or third-party imagery as your own premises, staff or food apply equally to stock photography;
- **If you need full rights**, replace stock photography with your own photographs through the Design Studio. We recommend this for any image a customer could mistake for your actual food or premises.
...
After termination, BinaApp may **reclaim and reassign** the subdomain to another user.`,
    ...
    {
      id: 'lesen-pameran',
      title: '14A. Showcase and Publicity Licence',
      content: `BinaApp maintains a **showcase** of merchant websites — on the binaapp.my homepage and in marketing materials — to demonstrate what the platform produces.

**(a) The licence you grant**

Where you **publish a website to a live \`*.binaapp.my\` subdomain**, you grant BinaApp a **non-exclusive, royalty-free, worldwide, revocable licence** to:

- Display your published website, screenshots of it, and short recordings or hero video clips from it, in the BinaApp showcase and in BinaApp marketing materials, including social media;
- Use your **business name** and, where you supplied it, your logo, solely to identify whose website is shown;
- Link to your live website from the showcase.

**(b) The limits on that licence**

- The licence covers **only what you have published to the public** on your live subdomain. It does **not** extend to drafts, unpublished pages, preview subdomains, your menus as a data set, your customer data, your order data, or anything inside your dashboard;
- It is **revocable at will** (see (c)). It is not perpetual and it survives nothing;
- It grants **no ownership**. You retain everything under section 14.2, and nothing here transfers copyright in your photographs, logo or copy;
- BinaApp will **not** state or imply that you endorse, recommend or are commercially affiliated with BinaApp beyond the plain fact that you use the platform;
- BinaApp will **not** sub-license your content to a third party for that third party's own marketing.

**(c) Withdrawing the licence — opt-out**

You may withdraw this licence **at any time and for any reason, without giving a reason**, by emailing **admin@binaapp.my** with the subject \`Showcase Opt-Out\` and your business name or subdomain.

- We will remove your website from the BinaApp showcase **within 7 working days** of receiving your request;
- Withdrawal has **no effect on your subscription, your plan, your pricing, your features or your support**. It is not a breach, and we will not penalise you for it;
- Material already printed or already posted to a third-party platform will be removed or withdrawn from circulation **as soon as practicable**, which may take longer than 7 working days for physical material;
- You may also ask us in advance never to feature you at all, and we will record that against your account.

**(d) Labelling of showcase entries**

Showcase entries are labelled to distinguish a **live** merchant website that is actually trading from a **demonstration** site built to show a design. BinaApp will not present a demonstration site as a trading business, and will not present your live site as a demonstration.

**(e) Your warranties for showcased content**

Where your site is showcased, you confirm that you hold the rights to the content on it — including any photographs of identifiable people — and that you have the consents needed for it to be displayed publicly. Your indemnity under section 19 applies to a third-party claim arising from content you published on your own site and which we then showed in the showcase.

**(f) Our discretion**

BinaApp is under **no obligation** to feature any merchant, and may remove any entry at any time without notice or reason. Inclusion is not a benefit of any plan, is not a ranking, is not an endorsement of your business, and carries no commercial value that could be claimed.`,
    },
...
You are encouraged to read each third-party provider's privacy policy to understand their privacy practices. BinaApp does not control those policies and **is not responsible** for changes in provider privacy practices.`,
      thirdPartyTable: [
        ...
        },
        {
          ...
          region: "People's Republic of China",
          purpose:
            'AI website generation (glm-5.3), generated-image production (glm-image / CogView), automated visual design critique (glm-4.5v), and hero video generation (CogVideoX / wan / HappyHorse)',
          policyUrl: 'https://z.ai/terms/privacy-policy',
        },
        {
          service: 'Cloudinary',
          region: 'United States / global CDN',
          purpose:
            'Hosting, transformation and delivery of every image and hero video clip on generated websites; receives the IP address of your website visitors',
          policyUrl: 'https://cloudinary.com/privacy',
        },
        {
          service: 'Unsplash',
          region: 'United States / global CDN',
          purpose: 'Stock photography served to visitors of generated websites',
          policyUrl: 'https://unsplash.com/privacy',
        },
        {
          service: 'Google (Maps embed and Fonts)',
          region: 'United States / global',
          purpose:
            'The map frame on the contact section and the web fonts used by the page design, both loaded directly by your visitors\u2019 browsers; Google may set its own cookies in the map frame',
          policyUrl: 'https://policies.google.com/privacy',
        },
        {
          service: 'OpenStreetMap Foundation (Nominatim)',
          region: 'European Union / global',
          purpose: 'One-time geocoding of the business address at publish time',
          policyUrl: 'https://osmfoundation.org/wiki/Privacy_Policy',
        },
        {
          service: 'Public code CDNs (Tailwind, unpkg, cdnjs, jsDelivr)',
          region: 'Global',
          purpose:
            'Stylesheets, icon fonts and small scripts that generated websites load into visitors\u2019 browsers',
  ...
  changelog: [
    {
      ...
      changes: [
        'MATERIAL — New section 11A on AI-generated video: a hero clip is synthetic footage and is not a recording of your premises, staff or food. You must review every clip before publishing and must not present one as genuine footage of your business. Express notice that doing so may engage the Trade Descriptions Act 2011, the Consumer Protection Act 1999 and the Malaysian Code of Advertising Practice, and that this liability is the merchant\u2019s;',
        'MATERIAL — New section 13A on automated content controls: the pipeline may rewrite unsupported claims, remove sections stating facts the merchant never supplied, block generation on a location conflict, drop images failing a vision check, regenerate or refuse to publish a page below the quality floor, refuse a publish that would overwrite a live site, and neutralise unverifiable links. Express statement that these controls are a safety net and NOT a warranty of accuracy, and that the merchant remains responsible for reviewing the published page;',
        'MATERIAL — New section 14A granting BinaApp a revocable, non-exclusive, royalty-free licence to feature a merchant\u2019s published website, business name and hero clip in the BinaApp showcase and marketing, limited to publicly published content, with a no-questions-asked opt-out at admin@binaapp.my honoured within 7 working days and with no effect on subscription, pricing, features or support;',
        'MATERIAL — New third-party providers added to the third-party services table and disclosed: Z.ai / Zhipu AI (People\u2019s Republic of China), Cloudinary, Unsplash, Google Maps and Fonts, OpenStreetMap Nominatim, and public code CDNs (section 17);',
        'MATERIAL — Express notice that the automated visual review sends screenshots of the generated page to a vision model, and that hero video generation from a photograph sends that photograph to a provider in the People\u2019s Republic of China (sections 11 and 12);',
        'New section 14.5 on stock photography and third-party assets: the merchant does not own them, the Unsplash Licence governs their use, and a stock photograph must not be presented as the merchant\u2019s own premises or food;',
        'Section 14.3 extended to hero video clips, with express notice that AI provider terms pass through to the merchant and that copyright in purely machine-generated output is legally unsettled;',
        'Section 13 feature list extended with the hero video studio, Design Studio, website rebuild and style variations, template gallery, QR/promo/counter/business kits, the Google Maps embed and address geocoding, the booking form section, issue reporting and free regeneration, referrals, trust score and merchant penalties, and SLA and website health monitoring;',
        'Disclosure that the booking / reservation form on generated websites submits nothing to BinaApp — entries are handed to WhatsApp from the visitor\u2019s browser, BinaApp stores no bookings and cannot recover or export them, and the merchant is their sole controller (section 13(r));',
        'Hero video credit treatment stated: a provider or platform failure returns the credit automatically; dissatisfaction with the creative result of a successfully rendered clip does not (section 11A);',
        'Section 12 updated to record the status of the v3.0 privacy commitments: Do-Not-Track support delivered and exceeded (analytics are now cookieless and Global Privacy Control is honoured), while the AI consent UI and visitor notice banner were not delivered by 20 July 2026 and are recommitted to 31 January 2027.',
      ],
    },
    {
      version: '3.0',
