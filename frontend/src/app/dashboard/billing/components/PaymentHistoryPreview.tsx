    ...
    <div>
      ...
      {renderable.length === 0 ? (
        ...
        <div className="overflow-hidden rounded-[18px] border border-ink-200 bg-white">
          <div className="grid grid-cols-[110px_1fr_120px_110px] gap-3 border-b border-ink-200 bg-ink-050 px-5 py-2.5 font-geist-mono text-[10px] font-medium uppercase tracking-[0.1em] text-ink-400">
            <div>Tarikh</div>
            <div>Penerangan</div>
          ...
          {renderable.map((tx, i) => (
            <div
              ...
              className={`grid grid-cols-[110px_1fr_120px_110px] gap-3 px-5 py-3.5 ${
                i === renderable.length - 1 ? '' : 'border-b border-ink-100'
              } items-center transition-colors hover:bg-[#FAFAFD]`}
            >
